...
//พิมพ์ข้อความ  
$pdf->SetTextColor(255,0,0) ; // กำหนดสีตัวหนังสือสีแดง
$pdf->SetXY(25,35);	// กำหนดพิกัด 25,35
$pdf->SetFont('regular','',16); 	// ใช้ Font angsana แบบปกติ ขนาด 16
$pdf->Write(10,'ตัวหนังสือปกติ สีแดง');  // พิมพ์ข้อความว่า ตัวหนังสือปกติ ที่ตำแหน่งจากด้านบนลงมาตามแกน Y 10 จุด
$pdf->SetTextColor(0,255,0) ; // กำหนดสีตัวหนังสือสีเขียว
$pdf->SetXY(25,40);	// กำหนดพิกัด 25,40  	
$pdf->SetFont('bold','B',16); 	// ใช้ Font angsanab แบบตัวหนา ขนาด 16
$pdf->Write(10,'ตัวหนังสือหนา สีเขียว');  // พิมพ์ข้อความว่า ตัวหนังสือหนา ที่ตำแหน่งจากด้านบนลงมาตามแกน Y 10 จุด	
$pdf->SetTextColor(0,0,255) ; // กำหนดสีตัวหนังสือสีน้ำเงิน
$pdf->SetXY(25,45);	// กำหนดพิกัด 25,45  
$pdf->SetFont('italic','I',16);	// ใช้ Font angsanai แบบตัวเอียง ขนาด 16
$pdf->Write(10,'ตัวหนังสือเอียง สีน้ำเงิน');  // พิมพ์ข้อความว่า ตัวหนังสือเอียง ที่ตำแหน่งจากด้านบนลงมาตามแกน Y 10 จุด	 	
